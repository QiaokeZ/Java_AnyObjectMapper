...
public final class Mapper {
    ...
    @NotNull
    public static Map encode(@NotNull Object instance) throws Exception {
        return encode(instance, null);
    }

    @NotNull
    public static Map encode(@NotNull Object instance, @Nullable Serializer serializer) throws Exception {
    ...
    private static Map encode(Map<String, Object> map, Serializer serializer) throws Exception {
        Map keyValues = new HashMap();
    ...
    private static Object encode(List list, Serializer serializer) throws Exception {
    ...
    private static Object encode(AnyObject anyObject, Serializer serializer) throws Exception {
    ...
    private static void encode(Map container, String key, Object value, Serializer serializer) throws Exception {
        if (value instanceof Number) {
    ...
    private static <T> T decode(BeanContext context, Map map, Serializer serializer) throws Exception {
        ...
        for (Map.Entry<String, FieldContext> entry : context.fields.entrySet()) {
            ...
            if (value != null) {
                Property property = new Property(context, bean, serializer, fieldContext, key, value);
